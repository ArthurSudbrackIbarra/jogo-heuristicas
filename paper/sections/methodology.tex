...
% The artifact was evaluated by HCI students and professors/researchers reached via convenience sampling within this educational context. The primary deployment was an HCI evaluation course at a Brazilian university (omitted for double-blind review), where the course instructor applied the game during regular class time, after the ten heuristics had already been introduced through the standard course content. A complementary group of participants was reached through the research team's academic network and consisted of additional students and researchers in HCI. Some students additionally reported professional experience outside the university as a secondary characteristic; the study did not recruit industry-only practitioners.
