...
\title{Instructions for Authors of SBC Conferences 
Papers and Abstracts} %deve ser no mesmo idioma do texto
...
\begin{abstract}\textcolor{blue}{
\textbf{Introduction}: A good abstract, in addition to succinctly informing the content of a scientific article, serves to attract attention to the work. However, in recent years, many articles submitted to IHC do not present any type of standardization of abstracts, which also hinders the review process.
\textbf{Objective:} In camera-ready version, we will adopt a  STRUCTURED ABSTRACT as a way to organize the works.
...
\textbf{Results:} Thus, it is expected that there will be an improvement in the presentation of abstracts. ATTENTION: In short papers, it should be changed to "Expected Results", since they mostly present research intentions and/or partial results. \textbf{The abstract should contain a maximum of 10 lines and must include the topics described here. It should not be in blue. Here it is only highlighted}.}
\end{abstract}
...
\begin{resumo} \textcolor{blue}{
  \textbf{Introdução:} Um bom resumo, além de informar sucintamente o conteúdo de um artigo científico, serve para atrair a atenção para o trabalho. Contudo, nos últimos anos, muitos artigos submetidos ao IHC, não apresentam nenhum tipo de padronização dos resumos, o que, também dificulta o processo de revisão. 
  \textbf{Objetivo:} Na versão final, adotaremos o RESUMO ESTRUTURADO, como forma de organizar os trabalhos. 
  ...
  \textbf{Resultados:} Assim espera-se que haja uma melhora na apresentação dos resumos. ATENÇÃO: Em trabalhos curtos, deve-se trocar para ``Resultados Esperados'', uma vez que eles apresentam na maioria das vezes, intenções de pesquisa e/ou resultados parciais. \textbf{O resumo deve conter no máximo 10 linhas e, obrigatoriamente, os tópicos aqui descritos. Não deve estar na cor azul. Aqui é apenas um destaque}.}
\end{resumo}
...
%\pdftooltip usado para definir a descrição da imagem a ser lida por leitores de tela. Usado com o pacote \usepackage{pdfcomment} 
 \pdftooltip{\includegraphics[width=.5\textwidth]{figures/fig1.jpg}}
...
\begin{figure}[ht]
\centering
 \pdftooltip{\includegraphics[width=.3\textwidth]{figures/fig2.jpg}}
