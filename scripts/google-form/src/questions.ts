...
export const heuristicNames: Bilingual[] = [
  { en: '1. Visibility of System Status', pt: '1. Visibilidade do Status do Sistema' },
  {
    en: '2. Match Between System and the Real World',
    pt: '2. Correspondência entre o Sistema e o Mundo Real',
  },
  { en: '3. User Control and Freedom', pt: '3. Controle e Liberdade do Usuário' },
