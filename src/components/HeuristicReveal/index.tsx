...
export function HeuristicReveal({ heuristic, isLast, coinsAfterThis, onNext }: HeuristicRevealProps) {
      ...
      <div className={styles.card}>
        ...
        <div className={styles.comparison}>
          <div className={`${styles.compItem} ${styles.compBad}`}>
            ...
            <span className={styles.compLabel}>{t('reveal.withoutHeuristic')}</span>
            <p className={styles.compText}>{pick(heuristic.scenarios[0].narratorAfter)}</p>
          </div>
          <div className={`${styles.compItem} ${styles.compGood}`}>
            <span className={styles.compIcon}>✓</span>
            <span className={styles.compLabel}>{t('reveal.withHeuristic')}</span>
            <p className={styles.compText}>{pick(heuristic.scenarios[1].narratorAfter)}</p>
          </div>
        </div>
