      ...
      <div className={styles.content}>
        ...
        <div className={styles.stats}>
          <div className={styles.stat}>
            ...
            <span className={styles.statLabel}>{t('results.stats.heuristics')}</span>
          </div>
          <div className={styles.stat}>
            <span className={styles.statValue}>20</span>
            <span className={styles.statLabel}>{t('results.stats.scenarios')}</span>
          </div>
          <div className={styles.stat}>
            <span className={styles.statValue}>{avgTime}s</span>
            <span className={styles.statLabel}>{t('results.stats.avgTime')}</span>
          </div>
        </div>
          ...
          <div className={styles.list}>
            {heuristics.map((h) => (
              <div key={h.id} className={styles.listItem}>
                ...
                <span className={styles.checkmark} aria-label={t('heuristic.completed')}>✓</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className={styles.feedbackSection}>
          ...
          <p className={styles.feedbackSubtitle}>{t('results.feedbackSubtitle')}</p>
          <a
