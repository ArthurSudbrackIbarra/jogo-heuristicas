  ...
  scenarios: [
    {
      ...
      audioBefore: { pt: "audios/pt/H2BBPT.mp3", en: "audios/en/H2BBEN.mp3" },
      narratorAfter: {
      ...
      audioAfter: { pt: "audios/pt/H2BAPT.mp3", en: "audios/en/H2BAEN.mp3" },
    },
    {
      kind: "good",
      ...
      audioBefore: { pt: "audios/pt/H2GBPT.mp3", en: "audios/en/H2GBEN.mp3" },
      narratorAfter: {
      ...
      audioAfter: { pt: "audios/pt/H2GAPT.mp3", en: "audios/en/H2GAEN.mp3" },
    },
  ],
  revealText: {
