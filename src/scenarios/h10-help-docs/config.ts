  ...
  scenarios: [
    {
      ...
      audioBefore: { pt: "audios/pt/H10BBPT.mp3", en: "audios/en/H10BBEN.mp3" },
      narratorAfter: {
      ...
      audioAfter: { pt: "audios/pt/H10BAPT.mp3", en: "audios/en/H10BAEN.mp3" },
    },
    {
      kind: "good",
      ...
      audioBefore: { pt: "audios/pt/H10GBPT.mp3", en: "audios/en/H10GBEN.mp3" },
      narratorAfter: {
      ...
      audioAfter: { pt: "audios/pt/H10GAPT.mp3", en: "audios/en/H10GAEN.mp3" },
    },
  ],
  revealText: {
