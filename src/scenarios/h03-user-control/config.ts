  ...
  scenarios: [
    {
      ...
      audioBefore: { pt: "audios/pt/H3BBPT.mp3", en: "audios/en/H3BBEN.mp3" },
      narratorAfter: {
      ...
      audioAfter: { pt: "audios/pt/H3BAPT.mp3", en: "audios/en/H3BAEN.mp3" },
    },
    {
      kind: "good",
      ...
      audioBefore: { pt: "audios/pt/H3GBPT.mp3", en: "audios/en/H3GBEN.mp3" },
      narratorAfter: {
      ...
      audioAfter: { pt: "audios/pt/H3GAPT.mp3", en: "audios/en/H3GAEN.mp3" },
    },
  ],
  revealText: {
