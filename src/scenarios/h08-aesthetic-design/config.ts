  ...
  scenarios: [
    {
      ...
      audioBefore: { pt: "audios/pt/H8BBPT.mp3", en: "audios/en/H8BBEN.mp3" },
      narratorAfter: {
      ...
      audioAfter: { pt: "audios/pt/H8BAPT.mp3", en: "audios/en/H8BAEN.mp3" },
    },
    {
      kind: "good",
      ...
      audioBefore: { pt: "audios/pt/H8GBPT.mp3", en: "audios/en/H8GBEN.mp3" },
      narratorAfter: {
      ...
      audioAfter: { pt: "audios/pt/H8GAPT.mp3", en: "audios/en/H8GAEN.mp3" },
    },
  ],
  revealText: {
