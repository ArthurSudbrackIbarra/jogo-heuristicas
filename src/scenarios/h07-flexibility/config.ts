  ...
  scenarios: [
    {
      ...
      audioBefore: { pt: "audios/pt/H7BBPT.mp3", en: "audios/en/H7BBEN.mp3" },
      narratorAfter: {
      ...
      audioAfter: { pt: "audios/pt/H7BAPT.mp3", en: "audios/en/H7BAEN.mp3" },
    },
    {
      kind: "good",
      ...
      audioBefore: { pt: "audios/pt/H7GBPT.mp3", en: "audios/en/H7GBEN.mp3" },
      narratorAfter: {
      ...
      audioAfter: { pt: "audios/pt/H7GAPT.mp3", en: "audios/en/H7GAEN.mp3" },
    },
  ],
  revealText: {
